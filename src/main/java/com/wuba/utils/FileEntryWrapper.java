...
import com.wuba.device.TestDevice;

/**
 * Implementation of a {@link IFileEntry}.
 */
public class FileEntryWrapper implements IFileEntry {
     ...
     */
    public FileEntryWrapper(TestDevice testDevice, FileEntry entry) {
     ...
     */
    public static IFileEntry getDescendant(IFileEntry fileEntry, List<String> childSegments)
            throws DeviceNotAvailableException {
